"""In this project, build a tool that makes secure, memorable passwords
to help keep your private information safe,This project will how to use Pythons random module. The program uses random choices from
...
nouns = ["apple", "dog", "cat", "car", "house", "book", "computer", "flower", "friend", "city", "tree", "music",
